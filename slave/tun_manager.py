#!/usr/bin/env python3
"""
TUN Device Manager - SLAVE
Identical to master's tun_manager.py; IP addresses are configured by the caller.
"""
...
def main():
    local_ip = sys.argv[1] if len(sys.argv) > 1 else '10.0.0.2'
    peer_ip  = sys.argv[2] if len(sys.argv) > 2 else '10.0.0.1'
    ...
    eprint('[TUN] Both bridges active.')
